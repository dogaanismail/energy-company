package org.energycompany.exception.handler;

import jakarta.validation.ConstraintViolationException;
import org.apache.commons.lang3.StringUtils;
import org.energycompany.exception.*;
...
public class GlobalExceptionHandler {
    ...
    protected ResponseEntity<CustomError> handlePasswordNotValidException(PasswordNotValidException ex) {
    ...
    protected ResponseEntity<Object> handleTokenAlreadyInvalidatedException(TokenAlreadyInvalidatedException ex) {
    ...
    protected ResponseEntity<Object> handleCustomerAlreadyExistException(CustomerAlreadyExistException ex) {
    ...
    @ExceptionHandler(CustomerStatusNotValidException.class)
    protected ResponseEntity<Object> handleCustomerStatusNotValidException(CustomerStatusNotValidException ex) {
