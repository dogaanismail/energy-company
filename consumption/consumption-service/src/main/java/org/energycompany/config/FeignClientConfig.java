...
import org.energycompany.serializer.UsernamePasswordAuthenticationTokenMixin;
...
public class FeignClientConfig {
    ...
    private static class CustomDecoder implements Decoder {
        ...
        public Object decode(Response response, Type type) throws IOException {
            ...
            // Handles specific HTTP status codes and return corresponding FeignExceptions
